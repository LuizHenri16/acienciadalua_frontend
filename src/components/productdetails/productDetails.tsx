    ...
    return (
        <main className="flex-1 flex flex-col lg:flex-row animate-in fade-in duration-700">
            <div className="relative lg:w-1/2 xl:w-[35%] h-82 sm:h-96 lg:h-full bg-[#1a0a2e] rounded-r-lg shrink-0 overflow-hidden hover:scale-[1.01] hover:shadow-lg transition-transform cursor-pointer">
                ...
                <div className="hidden lg:block absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-white/5 to-transparent pointer-events-none" />
            </div>
                ...
                <div className="max-w-xl w-full mx-auto lg:mx-0 space-y-10">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-5xl font-bold mt-1 bg-gradient-to-r from-turquesa-dark to-turquesa bg-clip-text text-transparent">
