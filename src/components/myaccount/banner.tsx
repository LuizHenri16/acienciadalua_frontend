...
export function Banner({ totalMateriais, userName }: BannerProps) {
    return (totalMateriais && totalMateriais > 0) ? (
        ...
        <div className="squircle-border border-3 border-dashed border-turquesa flex flex-col gap-2 px-4 py-8">
            <p className="text-sm text-texto-secundario">Seja <span className="text-turquesa-dark">Bem-vindo (a), </span> {userName}👋</p>
...
export function BannerNoMaterials() {
    ...
    return (
        <div className="flex flex-col justify-center items-center text-center gap-2 mt-4 bg-[#FEFFFF] border-turquesa border-3 border-dashed p-6 rounded-2xl squircle-border">
            <h3 className="text-lg font-bold text-texto-principal">Nenhum material ainda</h3>
            <p className="text-sm text-texto-secundario">Explore a vitrine e adquira seu primeiro material de estudo.</p>
