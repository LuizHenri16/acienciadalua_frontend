export function BannerSection() {
    return (
        <section className="squircle-border border-2 border-dashed border-turquesa shadow-sm bg-[#fafafa] flex flex-col justify-center gap-3 mt-2 px-6 py-10 md:py-16 md:px-12">
            ...
            <p className="text-sm md:text-lg text-texto-secundario max-w-xl leading-relaxed">
