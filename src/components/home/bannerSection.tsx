export function BannerSection() {
    return (
        <section className="banner flex flex-col justify-center gap-3 px-6 py-10 md:py-16 md:px-12">
            ...
            <h1 className="text-3xl md:text-5xl font-black leading-[1.1] max-w-2xl">
