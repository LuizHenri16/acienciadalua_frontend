export function AboutSection() {
    ...
    return (
        <article id="como-funciona" className="bg-white squircle-border overflow-hidden border-2 border-borda flex flex-col md:flex-row">
            ...
            <div className="flex flex-col justify-center gap-4 p-8 md:p-12 md:w-2/3">
                ...
                <p className="text-sm md:text-base text-texto-secundario leading-relaxed font-medium">
                    ...
                    não é a matéria, mas sim a forma de ensiná-la. Minha missão é tornar o aprendizado leve e eficaz.
                </p>
