...
export function ChemistryBackground() {
    const formulas = [
        // Bordas
        { content: "H₂O", top: "5%", left: "88%", size: "0.9rem", rotate: "10deg", opacity: 0.18, delay: 0.3, y: 6, dur: 4.2 },
    ...
    const icons = [
        // Bordas
        { content: "⚗️", top: "3%", left: "2%", size: "1.5rem", rotate: "-15deg", opacity: 0.22, delay: 0.4, y: 8, dur: 4.5 },
        { content: "🧪", top: "18%", left: "93%", size: "1.4rem", rotate: "8deg", opacity: 0.21, delay: 1.2, y: 7, dur: 5.3 },
    ...
    const bonds = [
        { top: "10%", left: "6%", opacity: 0.16, rotate: "20deg", delay: 0.5, y: 7, dur: 4.4, svg: (
